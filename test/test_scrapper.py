...
def test_generate_search_url():
    ...
    assert url == "https://data.sncf.com/api/records/1.0/search/?dataset=tgvmax&q=&facet=date&facet=origine&facet=destination&refine.origine=BAYONNE&refine.date=2022-01-31&refine.destination=PARIS+(intramuros)"
